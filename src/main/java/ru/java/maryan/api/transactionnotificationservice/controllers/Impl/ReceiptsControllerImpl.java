...
import ru.java.maryan.api.transactionnotificationservice.controllers.ReceiptsController;
...
public class ReceiptsControllerImpl implements ReceiptsController {
    private final S3Service s3Service;

    @Autowired
    public ReceiptsControllerImpl(S3Service s3Service) {
